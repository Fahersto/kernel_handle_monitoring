...
/**
*  User mode application to communicate with the handle monitoring driver
*
*/
int main(char argc, char** argv)
{
    ...
    printf("[Info] - Sending IOCTL code %x to driver\n", IOCTL_MONITOR_HANDLES_OF_PROCESS);

    char driverResponseBuffer[128];
    ...
    printf("[Info] - Driver responded with %d bytes: %s\n", bytesReturned, driverResponseBuffer);
